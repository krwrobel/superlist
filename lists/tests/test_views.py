...
class NewListViewUnitTest(unittest.TestCase):
    ...
    @patch('lists.views.render')
    #@patch('lists.views.redirect')    
    def test_does_not_save_if_form_invalid(self, mockRender, mockNewListForm):
        mock_form = mockNewListForm.return_value
        mock_form.is_valid.return_value = False
        new_list(self.request)
...
class ListViewTest(TestCase):
    ...
    def test_displays_only_items_from_given_list(self):
        correct_list = List.objects.create()
        Item.objects.create(text='itemey 1',list = correct_list)
        Item.objects.create(text='itemey 2',list = correct_list)
        incorrect_list = List.objects.create()
        Item.objects.create(text='other itemey 1',list = incorrect_list)
        Item.objects.create(text='other itemey 2',list = incorrect_list)
    ...
    def test_invalid_lists_are_not_saved(self):
